...
public class JweTokenStore implements TokenStore {
    ...
    private JweAccessTokenConverter jweTokenEnhancer;
    private ApprovalStore approvalStore;


    /**
     * Create a JweTokenStore with this token enhancer (should be shared with the DefaultTokenServices if used).
     *
     * @param jwtTokenEnhancer
     */
    public JweTokenStore(JweAccessTokenConverter jwtTokenEnhancer) {
        this.jweTokenEnhancer = jwtTokenEnhancer;
    }
    ...
    public OAuth2Authentication readAuthentication(String token) {
        return jweTokenEnhancer.extractAuthentication(jweTokenEnhancer.decode(token));
    }
    ...
    public OAuth2AccessToken readAccessToken(String tokenValue) {
        ...
        if (jweTokenEnhancer.isRefreshToken(accessToken)) {
    ...
    private OAuth2AccessToken convertAccessToken(String tokenValue) {
        return jweTokenEnhancer.extractAccessToken(tokenValue, jweTokenEnhancer.decode(tokenValue));
    }
    ...
    private OAuth2RefreshToken createRefreshToken(OAuth2AccessToken encodedRefreshToken) {
        if (!jweTokenEnhancer.isRefreshToken(encodedRefreshToken)) {
